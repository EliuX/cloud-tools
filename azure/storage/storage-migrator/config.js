...
export class StorageConfig {
    constructor(options = {}) {
        ...
        this.preserveDestinationContainers = options.preserveDestinationContainers || process.env.PRESERVE_DESTINATION_CONTAINERS === 'true' || false;
        this.synchronizeContainers = options.synchronizeContainers || process.env.SYNCHRONIZE_CONTAINERS === 'true' || false;
    }
